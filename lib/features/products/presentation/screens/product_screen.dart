...
class _ProductInformation extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref ) {
    ...
    //RIVERPOOD SABRA QUE ESTA INSTANCIA YA EXISTIA Y NO CREARA UNA NUEVA
    final productForm = ref.watch(productFormProvider(product));    
      ...
      child: Column(
        ...
        children: [
          ...
          _SizeSelector(
            ...
            onSizesChanged: ref.read(productFormProvider(product).notifier).onSizeCahnged, 
            ),
          const SizedBox(height: 5 ),
          _GenderSelector( 
            selectedGender: productForm.gender,
            onGenderChanged: ref.read(productFormProvider(product).notifier).onGenderCahnged,
            ),
          ...
          CustomProductField( 
            ...
            onChanged: ref.read(productFormProvider(product).notifier).onDescriptionCahnged,
          ),
          ...
          CustomProductField( 
            ...
            onChanged: ref.read(productFormProvider(product).notifier).onTagsCahnged,
          ),
              ...
              child: Stack(
                children: [
                  ...
                  Align(
                    ...
                    child: ClipRRect(
                      borderRadius: const BorderRadiusGeometry.only(topLeft: Radius.circular(20)),
                      child: Container(
                        height: 50, 
                        width: 50,
